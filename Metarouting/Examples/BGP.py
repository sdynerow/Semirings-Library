...
from Metarouting.Policy.BGP import *
...
m = Matrix (5, 5, bMatrix, cast=BGPt1)
...
#
#generateDotCode("bgp-dijkstra-n4", m, 1, [(pi1,nh1),(pi2,nh2),(pi3,nh3),(pi4,nh4)])
#generateDotCode("bgp-dijkstra-n4", m, 2, [(pi1,nh1),(pi2,nh2),(pi3,nh3),(pi4,nh4)])
#generateDotCode("bgp-dijkstra-n4", m, 3, [(pi1,nh1),(pi2,nh2),(pi3,nh3),(pi4,nh4)])
#generateDotCode("bgp-dijkstra-n4", m, 4, [(pi1,nh1),(pi2,nh2),(pi3,nh3),(pi4,nh4)])
#
#(pi1,nh1) = bellman(m, 1)
#(pi2,nh2) = bellman(m, 2)
#(pi3,nh3) = bellman(m, 3)
...
#
#generateDotCode("bgp-bellman-n4", m, 1, [(pi1,nh1),(pi2,nh2),(pi3,nh3),(pi4,nh4)])
#generateDotCode("bgp-bellman-n4", m, 2, [(pi1,nh1),(pi2,nh2),(pi3,nh3),(pi4,nh4)])
#generateDotCode("bgp-bellman-n4", m, 3, [(pi1,nh1),(pi2,nh2),(pi3,nh3),(pi4,nh4)])
#generateDotCode("bgp-bellman-n4", m, 4, [(pi1,nh1),(pi2,nh2),(pi3,nh3),(pi4,nh4)])
