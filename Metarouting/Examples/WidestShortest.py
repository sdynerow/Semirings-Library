...
#
#generateDotCode("wp-dijkstra-n4", m, 1, [(pi1,nh1),(pi2,nh2),(pi3,nh3),(pi4,nh4)])
#generateDotCode("wp-dijkstra-n4", m, 2, [(pi1,nh1),(pi2,nh2),(pi3,nh3),(pi4,nh4)])
#generateDotCode("wp-dijkstra-n4", m, 3, [(pi1,nh1),(pi2,nh2),(pi3,nh3),(pi4,nh4)])
#generateDotCode("wp-dijkstra-n4", m, 4, [(pi1,nh1),(pi2,nh2),(pi3,nh3),(pi4,nh4)])
#
#(pi1,nh1) = bellman(m, 1)
#(pi2,nh2) = bellman(m, 2)
#(pi3,nh3) = bellman(m, 3)
...
#
#generateDotCode("wp-bellman-n4", m, 1, [(pi1,nh1),(pi2,nh2),(pi3,nh3),(pi4,nh4)])
#generateDotCode("wp-bellman-n4", m, 2, [(pi1,nh1),(pi2,nh2),(pi3,nh3),(pi4,nh4)])
#generateDotCode("wp-bellman-n4", m, 3, [(pi1,nh1),(pi2,nh2),(pi3,nh3),(pi4,nh4)])
#generateDotCode("wp-bellman-n4", m, 4, [(pi1,nh1),(pi2,nh2),(pi3,nh3),(pi4,nh4)])
