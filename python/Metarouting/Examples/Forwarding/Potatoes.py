...
from Metarouting.Policy.Forwarding.ShortestF import *
from Metarouting.Policy.Forwarding.Potatoes import *
...
I = ShortestF.zeroElt
fSimple = ForwardingMatrix(5, 2, [ I, I 
                                 , 3, I
                                 , I, I
                                 , I, 1
                                 , 2, 3], cast = ShortestF)

fHot = ForwardingMatrix(5, 2, [  None,  None 
                              , (0,3),  None
                              ,  None,  None
                              ,  None, (0,1)
                              , (0,2), (0,3)], cast = toHotPotato)

fCold = ForwardingMatrix(5, 2, [  None,  None 
                               , (0,3),  None
                               ,  None,  None
                               ,  None, (0,1)
...
print "Forward matrix (SP) [RLO ⊠ F]:\n" + str(rlo * fSimple) + "\n"
print "Forward matrix (HP) [RLO ⊠ F]:\n" + str(rlo * fHot) + "\n"
print "Forward matrix (CP) [RLO ⊠ F]:\n" + str(rlo * fCold)
